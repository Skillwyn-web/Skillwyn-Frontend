...
const TypewriterText = () => {
    const texts = [
        "Master DSA & crack product companies.",
        ...
        <div className="flex min-h-screen bg-white">
            ...
            <div className="flex flex-1 flex-col justify-center px-6 py-12 sm:px-10 lg:px-20 xl:px-24">
                <div className="mx-auto w-full max-w-[420px]">
                    <h2 className="text-[36px] font-bold tracking-tight !text-[#102a7a] mb-3">Sign In</h2>
                    <p className="text-[15px] font-medium !text-slate-500 mb-10">Enter your credentials to access your account</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-2.5">
                                ...
                                <Link href="#" className="text-sm font-bold !text-[#3b82f6] hover:text-[#2563eb] transition-colors">
                                    Forgot password?
                                </Link>
                            </div>
                        ...
                        <div className="flex items-center pt-2">
                            <input
                                ...
                                name="remember-me"
                                type="checkbox"
                                className="h-4.5 w-4.5 rounded-[4px] border-slate-300 text-[#3b82f6] focus:ring-[#3b82f6] transition-colors cursor-pointer"
                            />
                            <label htmlFor="remember-me" className="ml-3 block text-[14.5px] font-medium !text-slate-600 cursor-pointer select-none">
                    ...
                    <p className="mt-10 text-center text-[15px] font-medium !text-slate-500">
                        ...
                        <Link href="/signup" className="font-bold !text-[#2563eb] hover:text-[#1d4ed8] transition-colors">
                            Sign Up
                        </Link>
                    </p>
                </div>
